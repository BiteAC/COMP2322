        ...
        try:
            ...
            if if_modified_since:
                try:
                    ...
                    ims_timestamp = int(ims_datetime.timestamp())


                    if mtime <= ims_timestamp:

                        send_response(client_socket, 304, client_ip, path, method,
                                      last_modified=last_modified_date, keep_alive=keep_alive)
                        if not keep_alive: break
                        continue
